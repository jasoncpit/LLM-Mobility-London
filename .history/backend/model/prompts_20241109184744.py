...
9. Make sure the plan is a directed graph, and the travel mode is consistent between consecutive activities. If you go out for a walk, and you should go back to the start location. 
10. Make sure don't include home office if the user is working from home. Just say Home in the <Location> tag. 
"""
