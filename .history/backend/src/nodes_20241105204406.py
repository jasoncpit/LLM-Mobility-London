...
if __name__ == "__main__":
    ...
    llm = LLM()
    nodes = Nodes(llm)
    state = WeeklyPlannerState(user_description="I am a software engineer who wants to plan my week who lives in Stratford, London and works in West Kensington, London")  # Initialize with proper parameters
    print(nodes.create_weekly_summary(state))
