...
if __name__ == "__main__":
    result = daily_schedule_node.invoke("A 30 year old married software engineer lives in Stratford and works in West Kensignton. He loves to travel and explore new places.")
    print(result)
