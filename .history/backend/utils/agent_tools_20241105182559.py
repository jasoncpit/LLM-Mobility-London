...
class GoogleAPIClient:
    ...
    def get_route(self, origin:POI, destination:POI):
        """
        ...
        payload = {
            "origin": {"location": {"latLng": origin.latitude, "lng": origin.longitude}},
            "destination": {"location": {"latLng": destination.latitude, "lng": destination.longitude}},
            "travelMode": "TRANSIT",
